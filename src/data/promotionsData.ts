...
export const INITIAL_PROMOTIONAL_PLACEMENTS: PromotionalPlacement[] = [
  {
    ...
    headline: 'Pembe Maize Meal (12x2kg Bale) — Save KES 120 Per Bale',
    subtext: 'High-grade sifted maize meal staple with fast duka inventory turnover. Guaranteed morning dispatch.',
    badgeText: 'Sponsored Deal • Unga Group PLC',
    discountKES: 120,
    boostScore: 35,
    cpcBidKES: 8.5,
    budgetKES: 150000,
    ...
    incentiveValue: 120,
    incentiveDescription: 'Instant wholesale discount of KES 120 per bale when ordering Pembe 12x2kg.',
    exclusiveBadgeText: 'Sponsored Deal • Unga Group PLC',
    callToActionText: 'Claim Deal',
  ...
  },
  {
    ...
    headline: 'Fresh Fri Cooking Oil (4x3L Carton) — Save KES 150 Per Carton',
    subtext: 'High-velocity 3L family carton. Triple-refined cooking oil for high-turnover retail kiosks.',
    badgeText: 'Sponsored Deal • Pwani Oil Products',
    discountKES: 150,
    boostScore: 40,
    cpcBidKES: 12.0,
    budgetKES: 120000,
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 150,
    incentiveDescription: 'KES 150 discount per carton on orders of Fresh Fri 4x3L.',
    exclusiveBadgeText: 'Sponsored Deal • Pwani Oil Products',
    callToActionText: 'Claim Deal',
  ...
  },
  {
    ...
    headline: 'Mumias Cane Sugar (20x1kg Bale) — Save KES 80 Per Bale',
    subtext: 'Pure white cane sugar staged for prompt wholesale fulfillment across regional depots.',
    badgeText: 'Sponsored Deal • Mumias Sugar',
    discountKES: 80,
    boostScore: 30,
    cpcBidKES: 6.0,
    budgetKES: 80000,
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 80,
    incentiveDescription: 'Wholesale discount of KES 80 per bale on Mumias Pure Sugar 20x1kg.',
    exclusiveBadgeText: 'Sponsored Deal • Mumias Sugar',
    callToActionText: 'Claim Deal',
  ...
  },
  {
    ...
    exclusiveBadgeText: 'Sponsored Deal • Upfield Kenya',
    callToActionText: 'Add Deal',
  ...
  },
  {
    ...
    placementSlot: 'HERO_BANNER',
    headline: 'Menengai Pure Soap (25x800g Carton) — Save KES 110 Per Carton',
    subtext: 'Long-lasting multipurpose laundry bar soap. Essential staple for high-density residential dukas.',
    badgeText: 'Sponsored Deal • Menengai Oil Refineries',
    discountKES: 110,
    boostScore: 35,
    cpcBidKES: 7.0,
    budgetKES: 100000,
    ...
    incentiveValue: 110,
    incentiveDescription: 'Wholesale discount of KES 110 on Menengai Pure Bar Soap 25x800g.',
    exclusiveBadgeText: 'Sponsored Deal • Menengai Oil Refineries',
    callToActionText: 'Claim Deal',
  ...
  },
  {
    ...
    targetCategory: 'Cleaning & Household',
    placementSlot: 'TOP_SEARCH_SPONSORED',
    headline: 'Omo Hand Washing Powder (24x500g) — Save KES 75 Per Carton',
    subtext: 'High-foaming laundry detergent powder in high consumer demand for neighbourhood kiosks.',
    badgeText: 'Sponsored Deal • Unilever Kenya',
    discountKES: 75,
    boostScore: 30,
    cpcBidKES: 6.5,
    budgetKES: 75000,
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 75,
    incentiveDescription: 'Wholesale discount of KES 75 per carton on Omo 24x500g.',
    exclusiveBadgeText: 'Sponsored Deal • Unilever Kenya',
    callToActionText: 'Claim Deal',
...
export const evaluateCampaignForShop = (
  ...
  return {
    ...
    callToActionText: campaign.callToActionText || 'Claim Trader Discount',
  };
};

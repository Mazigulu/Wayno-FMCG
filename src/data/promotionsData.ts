...
export const INITIAL_PROMOTIONAL_PLACEMENTS: PromotionalPlacement[] = [
  {
    ...
    incentiveValue: 120,
    incentiveDescription: 'Instant wholesale discount of KES 120 per bale when switching from Jogoo/Soko.',
    exclusiveBadgeText: '🎯 Brand Conquest Exclusive • KES 120 Discount',
  ...
  },
  {
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 150,
    incentiveDescription: 'KES 150 discount per carton on orders of 2+ cartons for verified Gold/Platinum dukas.',
  ...
  },
  {
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 80,
    incentiveDescription: 'Depot-subsidized KES 80 discount per bale to clear inventory before silo cycle.',
  ...
  },
  {
    ...
    targetCategory: 'Cleaning & Household',
    placementSlot: 'TOP_SEARCH_SPONSORED',
    headline: 'Welcome Back Trader Discount: Omo 24x500g + Branded Retail Counter Display',
    ...
    incentiveMechanism: 'CASH_DISCOUNT_KES',
    incentiveValue: 75,
    incentiveDescription: 'KES 75 re-engagement discount per carton + complimentary Unilever countertop display unit.',
    exclusiveBadgeText: '🔄 Welcome Back Trader • KES 75 Discount',
